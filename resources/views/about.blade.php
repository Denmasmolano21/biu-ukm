...
@include('layouts.navbar')
<div
  class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-emerald-100 via-white to-teal-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-all duration-700">
  <div class="text-center animate-fadeIn">
    <div class="mb-8">
      <svg class="w-24 h-24 text-emerald-600 dark:text-emerald-400 mx-auto animate-pulse" fill="none"
    ...
    <p class="text-gray-600 dark:text-gray-300 max-w-lg mx-auto mb-8">
      Maaf, halaman ini sedang dalam proses pembaruan untuk peningkatan sistem Portal UKM Bina Insani University.
      Silakan kembali beberapa saat lagi.
    </p>
    <a href="{{ url('/') }}"
      class="px-6 py-3 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold shadow-lg transition-all duration-300 hover:scale-105">
      Kembali ke Beranda
    </a>
  </div>
</div>
